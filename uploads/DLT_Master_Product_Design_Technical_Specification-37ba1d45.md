...
- Cashfree server-side confirmation
- Cashfree webhook
...
- Payment date/time
- Payment status
- Cashfree reference where appropriate
...
External payment must never be falsely represented as Cashfree payment.
...
- Student/passenger
- Amount
- Cashfree transaction/reference
- Payment status
- Refund status
- Duplicate status
...
- Cashfree payment can be completed.
